...
public abstract interface XmlPullParser {
	...
	public abstract void setInput(InputStream paramInputStream,
			String paramString) throws XmlPullParserException;

	public abstract String getInputEncoding();

	public abstract void defineEntityReplacementText(String paramString1,
	...
	public abstract String getAttributeValue(String paramString1,
			String paramString2);
	...
	public abstract void require(int paramInt, String paramString1,
			String paramString2) throws XmlPullParserException, IOException;

	public abstract String nextText() throws XmlPullParserException,
			IOException;
